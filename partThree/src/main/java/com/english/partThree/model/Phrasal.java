...
public class Phrasal extends AbstractModel implements ExAble {

    private String explain;
    private String example;

    public Phrasal(int id, String eng, String pl, int used, LocalDate localDate, LocalTime localTime, int favorite, String explain, String example) {
